...
namespace ScannerAndTransformations
{
    public partial class Form1 : Form
    {
        ...
        private void AffineTransformation_Click(object sender, EventArgs e)
        {
            ...
            CvInvoke.Blur(photo, grayImage, new Size(16, 16), new Point(-1, -1), BorderType.Constant);

            Mat hsv = new Mat();
            CvInvoke.CvtColor(grayImage, hsv, ColorConversion.Bgr2Hsv);
            Mat paper = new Mat();
            CvInvoke.InRange(hsv, (ScalarArray)new MCvScalar(0, 0, 0), (ScalarArray)new MCvScalar(180, 17, 184), paper);
            ...
            PointF[] sourcePoints = { verticies[0], verticies[3], verticies[1] };///corners dont match!!!********************
